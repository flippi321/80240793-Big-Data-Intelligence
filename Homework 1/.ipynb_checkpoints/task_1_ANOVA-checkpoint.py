...
# Settings
show_bar = True         # Whether we should show a bar-plot for the average age for each group category
...
if(show_bar):
    grouped_means.plot(kind='bar', xlabel='Group category', ylabel='Average age', title='Average year by Group category')
    plt.show()
